...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.4.13-green.svg" alt="Version 0.4.13">
...
```bash
git clone --branch "v0.4.13" --depth 1 https://github.com/mounirsetti/Llamanager.git
cd Llamanager
```
