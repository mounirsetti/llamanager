...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.3.98-green.svg" alt="Version 0.3.98">
...
```bash
git clone --branch "v0.3.98" --depth 1 https://github.com/mounirsetti/Llamanager.git
cd Llamanager
```
